...
import Organipousse from '../features/dashboard/components/Organipousse';
import OrganipoussV2 from '../features/dashboard/components/OrganipoussV2';

// Version simplifiée sans React Query pour commencer
const Entretien = () => {
  // État local
  const [activeTab, setActiveTab] = useState('entretiens'); // 'entretiens', 'organipousse', 'organipoussev2'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header - Masqué pour OrganipoussV2 */}
      {activeTab !== 'organipoussev2' && (
        <>
          ...
          <div className="bg-white border-b border-gray-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex space-x-8">
                ...
                <button
                  onClick={() => setActiveTab('organipoussev2')}
                  className={`py-3 px-1 border-b-2 font-medium text-sm transition-colors ${
                    activeTab === 'organipoussev2'
                      ? 'border-blue-500 text-blue-600'
                      : 'border-transparent text-gray-500 hover:text-gray-700'
