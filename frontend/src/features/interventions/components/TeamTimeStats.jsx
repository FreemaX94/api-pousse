...
import { useTeamTimeData } from '../hooks/useTeamTimeData';
...
const TeamTimeStats = () => {
  ...
  const [activeStatsTab, setActiveStatsTab] = useState('Equipe');
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold mb-4">Heures travaillées par {timeGroup.toLowerCase()} - Équipes</h3>
            <div className="h-80">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-lg font-semibold">Détails par équipe</h3>
              <button
                  ...
                  <tr>
                    {visibleColumns.equipe && (
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <SortButton column="equipe">Équipe</SortButton>
                      </th>
                    )}
                    {visibleColumns.type && (
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                      ...
                      {visibleColumns.equipe && (
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          <div className="flex items-center">
                            ...
                            <div className="flex items-center space-x-2">
                              <span className="font-medium">{item.equipe}</span>
