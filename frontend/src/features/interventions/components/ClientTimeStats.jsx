...
import { useClientTimeData } from '../hooks/useClientTimeData';

const ClientTimeStats = () => {
  ...
  const [activeStatsTab, setActiveStatsTab] = useState('Client');
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-blue-800 text-sm">
              <strong>Information :</strong> le budget du contrat client est défini sur la fiche de chaque client.
            </p>
          </div>

          {/* Graphique */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold mb-4">Heures travaillées par {timeGroup.toLowerCase()} - Clients</h3>
            <div className="h-80">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-lg font-semibold">Détails par client</h3>
              <button
                      ...
                      {visibleColumns.client && (
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          <div className="flex items-center">
                            ...
                            <div className="flex items-center space-x-2">
                              <button className="font-medium text-blue-600 hover:text-blue-900 hover:underline">
                                {item.client}
                              </button>
...
export default ClientTimeStats;