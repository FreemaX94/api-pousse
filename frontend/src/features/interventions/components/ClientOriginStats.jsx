...
import { useClientOriginData } from '../hooks/useClientOriginData';

const ClientOriginStats = () => {
  ...
  const [activeStatsTab, setActiveStatsTab] = useState('Provenance');
  ...
  // Fonction pour obtenir l'icône selon la provenance
  const getOriginIcon = (provenance) => {
    switch (provenance.toLowerCase()) {
      case 'site web':
      case 'référencement naturel':
        return '🌐';
      case 'google ads':
        return '📢';
      case 'réseaux sociaux':
        return '📱';
      case 'recommandation client':
      case 'bouche-à-oreille':
        return '👥';
      case 'prospection téléphonique':
      case 'prospection directe':
        return '📞';
      case 'salon professionnel':
        return '🏢';
      case 'partenaire commercial':
        return '🤝';
      case 'e-mailing':
        return '📧';
      default:
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold mb-4">Heures travaillées par {timeGroup.toLowerCase()} - Provenance des clients</h3>
            <div className="h-80">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-lg font-semibold">Détails par provenance</h3>
              <button
                  ...
                  <tr>
                    {visibleColumns.provenance && (
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <SortButton column="provenance">Provenance</SortButton>
                      </th>
                    )}
                    {visibleColumns.type && (
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          <div className="flex items-center">
                            <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center mr-3">
                              <span className="text-lg">{getOriginIcon(item.provenance)}</span>
                            </div>
                            <div className="flex items-center space-x-2">
                              <button className="font-medium text-orange-600 hover:text-orange-900 hover:underline">
                                {item.provenance}
                              </button>
...
export default ClientOriginStats;