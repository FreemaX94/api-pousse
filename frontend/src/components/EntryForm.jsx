...
export default function EntryForm({ onSaved, currentUser }) {
  ...
  const handleExtAddToStock = async () => {
    ...
    const payload = {
      ...
      diameter: extItem.DiameterCulturePot || extItem.Diameter || extItem.Opening || (extItem.PotSize ? parseInt(extItem.PotSize) : 0) || 0,
            ...
            <div style={{
              ...
              <div style={{flex: 1, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem', alignContent: 'start'}}>
                ...
                <div style={{
                  ...
                  <p style={{margin: 0, fontWeight: '700', fontSize: '1.2rem', color: 'var(--color-primary, #0d9488)'}}>{extItem.DiameterCulturePot || extItem.Diameter || extItem.Opening || (extItem.PotSize ? parseInt(extItem.PotSize) : 0) || 0} cm</p>
                </div>
                <div style={{
                  padding: '1.25rem', 
                  background: `linear-gradient(135deg, var(--color-primary, #0d9488), var(--color-accent, #14b8a6))`, 
